...
class PoissonTimeGenerator extends Random{
    constructor(initTime="00:00:00", timeMask="HH:mm:ss", interval=5, intervalUnit="minutes",lambda=2){
        ...
        this.lambda = lambda;
        this.time = moment2(this.initTime, this.timeMask);
    ...
    set accessIntervalTime(interval){
        this.interval = interval;
        this.timeInterval = moment2.duration(this.interval, this.intervalUnit);
    }
    ...
    generate(value = super.generate(false)){
        ...
        if(this.columnType === "Time") {
            try {
                ...
                const
                { mask } = this,
                currentTime = moment2(value, mask),
                beforeTime = moment2(this.firstPattern, mask),
                afterTime = moment2(this.secondPattern, mask);
                if(Math.random()<this.probability)
...
class TimeLapsFunction extends SwitchCaseFunction{
    ...
    transform(x){
        let inputTime = moment2(x, this.inputGenerator.timeMask);
    ...
    reset(){
        ...
        for(let lap of this.laps){
            let timeLap = moment2(lap, this.inputGenerator.timeMask);
...
class FixedTimeGenerator extends Sequence{
    constructor(initTime="00:00:00", step="00:00:10", timeMask="HH:mm:ss"){
        ...
        this.timeMask = timeMask;
        this.time = moment2(this.initTime, this.timeMask);
        this.timeStep = moment2(this.strStep, this.timeMask);
    }
